...
interface AutoCodeProps extends RouteChildrenProps {
...
> {
  ...
  onTabChange = (key: string) => {
    ...
    this.setState({
      tabKey: key as AutoCodeState['tabKey'],
    });
  };
  ...
  renderChildrenByTabKey = (tabKey: AutoCodeState['tabKey']) => {
    if (tabKey === 'projects') {
      return <Projects />;
    }
...
export default connect(
  ({
    ...
    currentUser: autoCode.currentUser,
    currentUserLoading: loading.effects['autoCode/fetchCurrent'],
  }),
)(AutoCode);
